import { AppBar, Avatar, Container, Grid, IconButton, Toolbar, Tooltip, Menu, Button, MenuItem, Box, Typography } from "@mui/material";
import { useState } from "react";
import Logo from "../colleenhoover.png"
                ...
                <Grid item lg={2} xs={3} md={5} sx={{ textAlign: "right"}}>
                  <Tooltip title="Perfil">
                    <IconButton onClick={handleOpenUserMenu}>
                      <Avatar alt="Manuela Kefraus" src=""/>
                    </IconButton>
                  </Tooltip>
                  <Menu
                  sx={{ mt: '45px' }}
